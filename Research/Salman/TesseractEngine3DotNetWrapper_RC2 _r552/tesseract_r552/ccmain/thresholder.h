...
class ImageThresholder {
 public:
  ...
  void SetThresholdMethod(int threshold_method)
  {
 ...
 protected:
  ...
  /// pointer from the class, to the output Pix.
  void IsodataLocalAdaptiveThresholdRectToPix(const unsigned char* imagedata,
                              int bytes_per_pixel, int bytes_per_line,
                              Pix** pix) const;

  /// Sauvola Local adaptive threshold the rectangle, taking everything except the image buffer
  /// pointer from the class, to the output Pix.
  void SauvolaLocalAdaptiveThresholdRectToPix(const unsigned char* imagedata,
                              int bytes_per_pixel, int bytes_per_line,
                              Pix** pix) const;
 ...
 protected:
  ...
  int                  rect_width_;
  int                  rect_height_;
  int				   threshold_method_; // method to (binarize) threshold image	
};
