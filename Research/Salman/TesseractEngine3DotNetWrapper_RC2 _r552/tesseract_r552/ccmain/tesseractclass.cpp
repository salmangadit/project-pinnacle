...
Tesseract::Tesseract()
  : BOOL_MEMBER(tessedit_resegment_from_boxes, false,
    ...
    BOOL_MEMBER(tessedit_dump_pageseg_images, false,
               ...
               this->params()),
	// MODIFIED: added tessedit_thresholding_method
    // date: 20110809
    INT_MEMBER(tessedit_thresholding_method, TM_ISODATA_LOCAL_ADAPTIVE_THRESHOLDING,
               "Thresholding method: 0=otsu, 1=isodata local adaptive, 2=sauvola local adaptive"
			   " (Values from ThresholdingMethod enum in publictypes.h)",
			   this->params()),
